			...
			770: function(e, t, n) {
				...
				t.loadWASM = function(e) {
					...
					if (c = !0, function(e) {
						...
						}(r) ? "function" == typeof WebAssembly.instantiateStreaming ? function(e) {
			...
			418: e => {
				var t = ("undefined" != typeof document && document.currentScript && document.currentScript.src, function(e = {}) {
					...
					Object.assign(r, o), o = null, r.arguments && r.arguments, r.thisProgram && r.thisProgram, r.quit && r.quit, r.wasmBinary && (a = r.wasmBinary), r
						.noExitRuntime, "object" != typeof WebAssembly && P("no native wasm support detected");
					...
					var _e, de = {
						...
						ge = function() {
							...
							return (e = a, t = E, i = f, o = function(e) {
								c(e.instance)
							}, e || "function" != typeof WebAssembly.instantiateStreaming || b(t) || "function" != typeof fetch ? U(t, i, o) : fetch(t, {
								credentials: "same-origin"
							}).then((e => WebAssembly.instantiateStreaming(e, i).then(o, (function(e) {
