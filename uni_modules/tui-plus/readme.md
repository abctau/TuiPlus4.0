...
TuiPlus框架刚刚诞生，像一匹桀骜不驯的小马，需要你的火眼金睛来驯服它！

现在，我们发起“捉虫英雄”召集令，只要你发现并提交 **10个有效BUG**，你将获得的不仅仅是我们的感谢，更是实打实的荣耀与特权：
...
*   **永久英雄榜**
    你的ID将永久镌刻在官网的“英雄榜”上，被所有后来者瞻仰！

*   **专属社区头衔**
    获得社区（如 Discord/微信群）专属**“代码质检官”**徽章，C位出道！

*   **定制感谢信**
    收到由创始人亲笔签名的电子感谢信，感谢你的神助攻！
...
*   **最高优先级**
    成为我们的**“荣誉顾问”**，你提出的1个功能建议或问题，将拥有最高优先级！

*   **内测资格**
    锁定所有新功能的**“内测资格”**，比全世界先一步体验未来！

*   **创始人1v1**
    获得与创始人**1v1交流**的宝贵机会，你的想法，我们认真听！

---

## 🚀 如何参与？

1.  **发现BUG**：在使用框架的过程中，任何不符合预期、可复现的问题。
2.  **提交BUG**：通过我们的 [GitHub Issues](https://github.com/abctau/TuiPlus4.0/issues) 页面提交，并使用 `BUG HUNT` 标签。
3.  **等待审核**：我们会尽快审核并确认你的提交。有效BUG将计入你的战绩。

> **重要提示**：一个“有效BUG”通常指“未被报告过的、可稳定复现的功能性问题或严重错误”。请尽可能提供详细的复现步骤、截图/录屏和相关代码片段。

---

这不只是一次测试，这是我们共同打造一个伟大作品的开端。你的每一次“挑刺”，都是在为它注入生命力。

**立即行动，成为我们故事的奠基人！**

[👉 点击这里提交你的第一个BUG](https://github.com/abctau/TuiPlus4.0/issues/new)

---

*（活动最终解释权归【你的项目/团队名】所有）*
